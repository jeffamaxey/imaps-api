    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gene', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='samples', to='genomes.gene')),
                ('pi', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pi_submitted_samples', to='core.user')),
                ('reads', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sample', to='django_nextflow.data')),
                ('scientist', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='submitted_samples', to='core.user')),
            ],
            options={
                'db_table': 'samples',
                'ordering': ['-created'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pipeline', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='link', to='django_nextflow.pipeline')),
            ],
            options={
